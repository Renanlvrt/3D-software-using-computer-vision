...
export class GestureRecognizer {
    constructor() {
        ...
        this.PINCH_THRESHOLD = 0.03; // Distance between thumb and index
    ...
    detectPinch(landmarks) {
        ...
        const isPinched = distance < this.PINCH_THRESHOLD;
    ...
    /**
     * Detect two-hand pinch gesture (for creating blocks)
