...
export class GestureRecognizer {
    constructor() {
        ...
        this.PINCH_ENTER_THRESHOLD = 0.03; // Stricter to start pinch (3cm)
        this.PINCH_EXIT_THRESHOLD = 0.05;  // Looser to release pinch (5cm) - Hysteresis
        this.PALM_THRESHOLD = 1.1;        // Multiplier for palm open detection
        this.MOVEMENT_SMOOTHING = 0.3;    // Smoothing factor for velocity


        /**
         * Compute two-hand pinch state from individual pinch states
         * @param {Object} leftPinch - Left hand pinch state
         * @param {Object} rightPinch - Right hand pinch state
         * @returns {Object} Two-hand pinch state
         */
        computeTwoHandGesture(leftPinch, rightPinch) {
